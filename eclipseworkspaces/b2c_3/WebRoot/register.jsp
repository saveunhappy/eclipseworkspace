...
<input type="text" placeholder="用户名" size="50" style="height:20px"/>
<span class="mb25">
...
<div style="width:880px;height:40px; float:right;margin-top:10px;"align="left";>
<input type="password" placeholder="密码" size="50" style="height:20px"/>
<span class="mb25">
...
<div style="width:880px;height:40px; float:right;margin-top:10px;"align="left";><a href="#"><img src="zhuce.png" /></a></div>
