...
<div id="main2">
  ...
  <div class="list_banner"> <a href="http://data.wbiao.cn/ad.php?ad_id=1138" target="_blank" rel="nofollow" onclick="_gaq.push(['_trackEvent','quan-zhan','heng-fu__1','http://data.wbiao.cn/ad.php?ad_id=1138']);"><img   src="" class="lazy" data-original="http://img2.wbiao.cn/ad/201403/21/139536510192630.jpg" alt="招行特惠" /></a> </div>
  <div style="clear:both">&nbsp;</div><s:property value="imgPath"/>
  <!--banner结束-->
  <div id="goods" style="width:1225px">
    ...
    <span class="sr w260"><b class="s20 cd6 f30"id="price"><font class="f12">￥</font>9500</b>
    ...
    <span class="sr"><del class="gray"id="market_price"><font class="f12">￥</font></del></span></div><div class="sa s13 w260"id="fen_qi_jia_container">
    ...
    <!-- <span class="btn minus"onclick="addorminus('minus','25521')"></span><input type="text"id="goods_number_25521"class="quantity"maxlength="4"size="2"value="1"name="good.number"/>
    <span class="btn add"onclick="addorminus('add','25521')"></span></span> -->
                
    	<form action="AddCartServlet" method="post" class="choose">
						<ul>
							...
							<li>
								<dl>
									...
									<dd>
										...
										<input type="number" name="amount" value="1" class="amount" width="20px" height="20px"/>
							...
							<li>
								<dl>
									<dt>&nbsp;</dt>
									<dd>
									<input type="hidden" name="goodsId" value="${sessionScope.good.goodsId }">
    ...
    <script type="text/javascript">var is_test=1;</script></div></div></div>
    <div class="images">
    <div class="big">
    ...
    <a href=""rel='gal1'id="image"onclick=""><img src="${sessionScope.good.imgPath}"class="lazy"data-original="${sessionScope.good.imgPath}"alt="瑞士爱宝时（EPOS）-Passion系列 3412.183.20.34.25 机械男表"class="middle_image"width="350"height="350"/></a>
      ...
      <div class="hot">
        ...
        <div class="h_mid"> <a rel="nofollow" class="h_link" href="http://www.sxgoing.comepos-g25523.html" target="_blank"> <img src="Images/blank.gif" class="lazy" data-original="http://imgh12.wbiao.cn/201303/01/3412_183_24_30_27_27885.jpg" alt="瑞士爱宝时（EPOS）-Passion系列 3412.183.24.30.27 机械男表" />
            ...
            <ul>
              ...
              <li>Passion系列</li>
              <li>男士机械表</li>
              <li style="margin-top:10px;" class="red f14 bold">￥<div>88</div></li>
              <li><del class="c666">￥88</del></li>
            </ul>
...
<div class="foot">
      <div class="r1 w1225">
        ...
        <div class="goods_content fl mt10 ml10">
			<!-- 商品概要信息 start -->
			<div class="summary">
				<h3><strong>${sessionScope.good.goodsName }  ${sessionScope.good.bak }</strong></h3>
				
				<!-- 图片预览区域 start -->
				<div class="preview fl">
					<div class="midpic">
						<a href="${sessionScope.good.imgPath }" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img width="350px" height="350px" src="${sessionScope.good.imgPath }" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
