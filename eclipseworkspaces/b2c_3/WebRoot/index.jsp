...
<div class="head">
	<div class="r1 w1225">
  <div class="ri">
           <span>您好，欢迎${sessionScope.name }来到喜悦名表！
				<c:if test="${sessionScope.name }==null">

					<a href="login.jsp">[登陆]</a><a href="regist.html">[免费注册]</a>
				</c:if>
				</span>
      </div>
    </div>
...
多多多多多多多 -->
        <div class="tBdy w1225" id="hotCon">
          ...
          <img src="${good.imgPath}"  width="250" height="250" />
                            <div class="tNm">百达翡丽 复杂功能计时系列 收藏家挚爱</div >
                            <div class="tPrc">￥${good.price}&nbsp;<i class="del">371100</i></div>
