...
<input type="text" placeholder="用户名" size="35" style="height:30px"/ name="username">
...
<input type="password" placeholder="密码" size="35" /style="height:30px" name="password"/>
...
<div style="width:495px;height:80px; float:right;" align="center";><a href="#"><img src="denglu.png"></a><a href="#"><strong> 忘记密码</strong></a></div>
